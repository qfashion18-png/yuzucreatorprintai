  ...
  return (
    <section className="rounded border border-slate-200 bg-[#06131a] p-6 text-white shadow-sm">
      <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="relative min-h-[220px] overflow-hidden rounded border border-white/10 bg-white/5 lg:w-[440px]">
          <Image
          ...
          <Link
            ...
            className="absolute bottom-4 right-4 inline-flex items-center justify-center rounded bg-white px-5 py-3 text-sm font-black text-[#06131a] shadow-sm transition hover:bg-[#d5ff5f]"
          >
            Build the kit
          </Link>
        </div>
